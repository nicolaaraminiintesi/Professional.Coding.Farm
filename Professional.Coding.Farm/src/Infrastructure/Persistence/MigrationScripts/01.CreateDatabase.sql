...
ALTER TABLE [dbo].Notifications  WITH CHECK ADD  CONSTRAINT [FK_TodoItems_Notifications] FOREIGN KEY(TodoListId)
REFERENCES [dbo].TodoLists ([ID])
GO

ALTER TABLE [dbo].Notifications CHECK CONSTRAINT [FK_TodoItems_Notifications]
GO